...
if(isset($_POST['save']))
{
    ...
    //SQL statement
    $sql="INSERT INTO student(std_username,std_password,std_name,std_matric,std_session,u_id)
            VALUES('$username','$password','$name','$matrix_no','$session','$u_id')";
