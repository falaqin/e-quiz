        ...
        <div class="card text-dark shadow" style="width: inherit;">
            <form action="import_process_std.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <a href="../assets/student.csv" class="btn btn-sm btn-info" title="Student CSV" download>CSV
                        Template Download</a>
                </div>
            </form>
        </div>
            ...
            <table class="table table-dark table-striped table-bordered shadow table-hover">
                ...
                while ($row = mysqli_fetch_assoc($query2)):
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="std_edit.php?id=<?php echo $row['std_id'] ?>"
                               class="btn btn-sm btn-success bi bi-pencil-square" title="Edit"></a>
                            <a href="javascript:void(0)"
                               onclick="delete_data('std_delete.php?id=<?php echo $row['std_id'] ?>')"
                               class="btn btn-sm btn-danger bi bi-trash" title="Delete"></a>
                        </td>
                    </tr>
        ...
        <?php if (!(isset($_POST['submit'])) and !(isset($_POST['submitclass']))): ?>
            <nav>
                <ul class="pagination">
                    ...
                    <?php } ?>
                    <li class="page-item <?php if ($_GET['page'] == $i - 1 or $_GET['page'] == '') {
                        echo "disabled";
                    } ?>">
