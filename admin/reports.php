...
//sql statement
$sql="SELECT ql.id, ql.title, ql.date_updated, u.user_name AS created_by, c.class_section AS std_class, c.class_id FROM `quiz_list` ql JOIN user u, student_quiz sq, class c WHERE ql.u_id = u.u_id AND ql.id = sq.quiz_id AND sq.class_id = c.class_id";
//run query
...
<div class="container text-light">
    ...
    <div class="table-responsive table-scroll">
        <table class="table table-dark text-light table-striped shadow table-bordered table-hover">
